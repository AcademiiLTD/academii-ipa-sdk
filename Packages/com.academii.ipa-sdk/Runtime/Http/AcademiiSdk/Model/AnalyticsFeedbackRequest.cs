...
namespace AcademiiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AnalyticsFeedbackRequest")]
    public partial class AnalyticsFeedbackRequest
    {
        /// <summary>
        ...
        public AnalyticsFeedbackRequest(Guid organizationId = default, DateTime startDate = default, DateTime endDate = default, bool includeArchived = default, decimal limit = default)
        {

...
namespace AcademiiSdk.Model
{
    ...
    public partial class User : IValidatableObject
    {
        ...
        [JsonConstructor]
        public User(string id, string email, Option<string?> uid = default, Option<string?> name = default, Option<string?> displayName = default, RoleEnum role = RoleEnum.Learner, Option<string?> organizationId = default, Option<string?> organization = default, Option<string?> photoURL = default, Option<string?> cognitoSub = default, Option<List<UserGroupsInner>?> groups = default, Option<DateTime?> createdAt = default, Option<DateTime?> updatedAt = default)
        {
            Id = id;
            Email = email;
            UidOption = uid;
    ...
    public class UserJsonConverter : JsonConverter<User>
    {
        ...
        public override User Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new User(id.Value!, email.Value!, uid, name, displayName, role.Value!.Value!, organizationId, organization, photoURL, cognitoSub, groups, createdAt, updatedAt);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, User user, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (user.OrganizationIdOption.IsSet)
                if (user.OrganizationIdOption.Value != null)
                    writer.WriteString("organization_id", user.OrganizationId);
                else

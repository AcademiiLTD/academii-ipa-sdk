...
namespace AcademiiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListMyTrainingResponseInput_topics_inner_courses_inner_modules_inner")]
    public partial class ListMyTrainingResponseInputTopicsInnerCoursesInnerModulesInner
    {
        /// <summary>
        /// Defines PackageType
        /// </summary>
        ...
        protected ListMyTrainingResponseInputTopicsInnerCoursesInnerModulesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMyTrainingResponseInputTopicsInnerCoursesInnerModulesInner" /> class.
        /// </summary>
        ...
        public ListMyTrainingResponseInputTopicsInnerCoursesInnerModulesInner(Guid id = default, Guid courseId = default, string name = default, string description = default, int sortOrder = default, string thumbnailUrl = default, bool isActive = default, PackageTypeEnum packageType = default, decimal progressPercent = default, string completionStatus = default, string progressState = default, DateTime? startedAt = default, DateTime? lastActivityAt = default, DateTime? completedAt = default)
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ListMyTrainingResponseInputTopicsInnerCoursesInnerModulesInner and cannot be null");
            }
            this.Name = name;
            ...
            {
                throw new ArgumentNullException("completionStatus is a required property for ListMyTrainingResponseInputTopicsInnerCoursesInnerModulesInner and cannot be null");
            }
            this.CompletionStatus = completionStatus;
            // to ensure "progressState" is required (not null)
            if (progressState == null)
            {
                throw new ArgumentNullException("progressState is a required property for ListMyTrainingResponseInputTopicsInnerCoursesInnerModulesInner and cannot be null");
            }

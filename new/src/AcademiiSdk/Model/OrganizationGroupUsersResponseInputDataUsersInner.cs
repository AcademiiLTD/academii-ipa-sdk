...
namespace AcademiiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationGroupUsersResponseInput_data_users_inner")]
    public partial class OrganizationGroupUsersResponseInputDataUsersInner
    {
        /// <summary>
        /// Defines Role
        /// </summary>
        ...
        protected OrganizationGroupUsersResponseInputDataUsersInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationGroupUsersResponseInputDataUsersInner" /> class.
        /// </summary>
        ...
        public OrganizationGroupUsersResponseInputDataUsersInner(Guid id = default, string email = default, string name = default, string displayName = default, RoleEnum? role = RoleEnum.Learner, Guid? organizationId = default, string photoURL = default)
        {
            this.Id = id;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for OrganizationGroupUsersResponseInputDataUsersInner and cannot be null");
            }
            this.Email = email;
            this.Name = name;

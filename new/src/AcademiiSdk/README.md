...
additionalProperties:
  packageGuid: '{AEF017E6-AE86-49EA-A689-A0FE1F3948D1}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IApiV1AdminHandbooksAllGetApiResponse apiResponse = await api.ApiV1AdminHandbooksAllGetAsync("todo");
            ApiV1AdminHandbooksAllGet200Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Academii IPA API
- appVersion: 1.0.0
- appDescription: Full REST API for the Academii IPA platform

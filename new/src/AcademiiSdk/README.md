...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IApiV1FilesUploadPostApiResponse apiResponse = await api.ApiV1FilesUploadPostAsync("todo");
...
## Api Information
- appName: Academii IPA Unity SDK API
- appVersion: 1.0.0
- appDescription: Unity SDK specific API endpoints for the Academii IPA platform

...
namespace AcademiiSdk.Test.Api
{
    ...
    public class DependencyInjectionTest
    {
        ...
        public void ConfigureApiWithAClientTest()
        {
            ...
            var unitySdkApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IUnitySdkApi>();
            Assert.True(unitySdkApi.HttpClient.BaseAddress != null);
        }
        ...
        public void ConfigureApiWithoutAClientTest()
        {
            ...
            var unitySdkApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IUnitySdkApi>();
            Assert.True(unitySdkApi.HttpClient.BaseAddress != null);
        }
        ...
        public void AddApiWithAClientTest()
        {
            ...
            var unitySdkApi = _hostUsingAddWithAClient.Services.GetRequiredService<IUnitySdkApi>();
            Assert.True(unitySdkApi.HttpClient.BaseAddress != null);
        }
        ...
        public void AddApiWithoutAClientTest()
        {
            ...
            var unitySdkApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IUnitySdkApi>();
            Assert.True(unitySdkApi.HttpClient.BaseAddress != null);
        }
    }
}

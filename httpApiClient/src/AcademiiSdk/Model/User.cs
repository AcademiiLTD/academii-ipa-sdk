...
namespace AcademiiSdk.Model
{
    ...
    public partial class User
    {
        ...
        public User(string id = default, string uid = default, string email = default, string name = default, string displayName = default, RoleEnum role = RoleEnum.Learner, string organizationId = default, string organization = default, string photoURL = default, string cognitoSub = default, List<UserGroupsInner> groups = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
